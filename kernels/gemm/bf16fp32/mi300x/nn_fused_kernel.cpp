// BF16 NN GEMM via fused transpose+NT: C = A @ B where B is KxN
//
...
#define HK_MODULE_NAME hk_nn_fused
#endif
PYBIND11_MODULE(HK_MODULE_NAME, m) {
    m.def("dispatch", [](pybind11::object A, pybind11::object B, pybind11::object C) {
        ...
        size_t needed = (size_t)Nsz * Ksz * sizeof(bf16);
    ...
    }, "BF16 NN GEMM via transpose+NT: C = A @ B");
}
